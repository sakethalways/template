...
const HeroSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-[100svh] flex flex-col justify-start overflow-hidden project-px pt-20 md:pt-24 lg:flex-row lg:items-center lg:pt-12"
    >
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-start lg:items-center w-full mx-auto">
        <div className="relative flex justify-center items-center h-[240px] md:h-[450px] lg:h-[600px] order-1 lg:order-2">
        ...
        <div className="text-left order-2 lg:order-1 lg:mt-0 mt-0 flex flex-col">
